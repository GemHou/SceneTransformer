...
class Decoder(nn.Module):
    def __init__(self, device, time_steps=91, feature_dim=256, head_num=4, k=4, F=6):
        ...
        self.layer_U = SelfAttLayer_dec(self.device, self.time_steps, self.feature_dim, self.head_num, self.k,
                                        across_time=True)
        ...
        self.layer_X = SelfAttLayer_dec(self.device, self.time_steps, self.feature_dim, self.head_num, self.k,
                                        across_time=False)
